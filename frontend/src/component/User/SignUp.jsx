          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Arvi Lights Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Arvi Lights Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge Arvi Lights will use my information in accordance
              with its
